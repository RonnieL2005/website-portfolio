...
function App() {
        ...
        <div className="flex items-center justify-between w-full px-6">
          ...
          <div className="flex space-x-4">
            <Link
              ...
              smooth={true}
              duration={300}
              className="font-major-mono font-bold text-xl text-black cursor-pointer"
              spy={true}
              activeClass="active"
              offset={-70}
              delay={0}
  ...
  <div className="flex items-center space-x-6">
    <div className="flex flex-col space-y-2">
      <h1 className="font-extrabold text-black text-5xl font-darker-grotesque">
    ...
    <img src="/ronnie-photo.jpeg" alt="Ronnie" className="w-48 h-48 rounded-full shadow-lg" />
  </div>
  <div className="flex items-center space-x-4 mt-20">
    <p className="font-darker-grotestque font-bold text-3xl text-black">
      Tech Stack |
    </p>
